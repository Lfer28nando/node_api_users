...
                verifiedEmail: userSaved.verifiedEmail,
                twoFactorEnabled: userSaved.twoFactorEnabled,
                consentAccepted: userSaved.consentAccepted,
...
                verifiedEmail: userFound.verifiedEmail,
                ...
                consentAccepted: userFound.consentAccepted,
...
            twoFactorEnabled: req.user.twoFactorEnabled,
            consentAccepted: req.user.consentAccepted, // Campo añadido
...
                verifiedEmail: userFound.verifiedEmail,
                twoFactorEnabled: userFound.twoFactorEnabled,
                consentAccepted: userFound.consentAccepted, // Campo añadido
                createdAt: userFound.createdAt,
                updatedAt: userFound.updatedAt
            }
        });
...
        // Verificar si el usuario tiene contraseña (no OAuth)
        if (!userFound.password) {
            throw createError('AUTH_OAUTH_USER', { email: userFound.email });
        }
...
//#08 - Resetear contraseña con código.
...
                username: userFound.username,
                email: userFound.email,
                role: userFound.role, // Añadido para consistencia
                verifiedEmail: userFound.verifiedEmail,
                twoFactorEnabled: userFound.twoFactorEnabled // Añadido para consistencia
            }
        });
        
    } catch (error) {
...
//#17- Eliminar cuenta (unsubscribe)
...
        // Verificar si el usuario tiene contraseña (no OAuth)
        if (!user.password) {
            throw createError('AUTH_OAUTH_USER', { email: user.email });
        }
